  ...
  <header class="header" data-header>
    ...
    <div class="header-bottom">
      <div class="container">
        ...
        <a href="#" class="logo">
          <img src="{{asset('asset/images/logo-light.png')}}" alt="Homeverse logo">
        </a>
        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="{{route('contact.form')}}" class="navbar-link" data-nav-link>Contact</a>
              </li>
      ...
      <section class="hero" id="home">
        <div class="container">
          ...
          <figure class="hero-banner">
            <img src="{{asset('asset/images/hero-banner.png')}}" alt="Modern house model" class="w-100">
          </figure>
